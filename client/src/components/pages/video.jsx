...
const HandelSub = async ()=>{
  ...
  await axios.put(`http://localhost:8800/api/users/unsub/${channel._id}`,null,{withCredentials: true})    
                         :
await axios.put(`http://localhost:8800/api/users/sub/${channel._id}`,null,{withCredentials: true})
